...
- Select a dataset from [Kaggle](https://www.kaggle.com/datasets/), and use it to test your implementation by performing statistical analyses on a real application.

---

# B) Interpolation module

Implement a module to support [**composite** linear and polynomial interpolation](https://en.wikipedia.org/wiki/Polynomial_interpolation), and (**bonus**) [cardinal cubic B-spline interpolation](https://www.boost.org/doc/libs/latest/libs/math/doc/html/math_toolkit/cardinal_cubic_b.html) of a given set of data $\lbrace(x_i, y_i)\rbrace \subset \mathbb{R}^2$.
...
- The integration of third-party libraries is highly encouraged, such as:
  ...
  - [`GetPot`](https://getpot.sourceforge.net/), for parsing command line arguments and configuration files
